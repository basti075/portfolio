...
export default [
  new ProjectData("project-6", "Hunt The Outline", "img/projects/hto.png", `
    <div class="paragraph">
      <strong>Hunt the Outline</strong> is a thing of beauty that I am so proud of. It's available on Windows Store because why not.
    ...
    `, "#ff6600", true, false, 88),
  new ProjectData("project-7", "Druu Blood", "img/projects/project-7-icon.png", `
    <div class="paragraph">
